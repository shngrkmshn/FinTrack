...
namespace FinTrackPro.Infrastructure.Migrations
{
    ...
    [Migration("20260317220154_AddBudgets")]
            ...
            modelBuilder.Entity("FinTrackPro.Domain.Entities.Budget", b =>
                {
                    ...
                    b.OwnsOne("FinTrackPro.Domain.ValueObjects.Money", "SpentAmount", b1 =>
                        {
                            b1.Property<Guid>("BudgetId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("FinTrackPro.Domain.ValueObjects.DateRange", "Period", b1 =>
                        {
                            b1.Property<Guid>("BudgetId")
                                .HasColumnType("uuid");
